...
import $ from 'jquery'
import { fsFriendlyName, mkRand } from '../../common'
...
export default class PascoMainNodeSettingsController {
  ...
  init (node) {
    ...
    var record_btn = this._document.getElementById('node-record-btn')
  ...
  initAudioTable (node) {
    var tbody = this._document.getElementById('node-audio-tbody')
    tbody.innerHTML = ''
